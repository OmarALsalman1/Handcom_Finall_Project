...
class ElectricityWorkersPage extends StatefulWidget {
  const ElectricityWorkersPage({super.key});

  @override
  State<ElectricityWorkersPage> createState() => _ElectricityWorkersPageState();
}

class _ElectricityWorkersPageState extends State<ElectricityWorkersPage> {
  ...
  Future<void> _loadWorkers() async {
    final results = await Future.wait([
      ProviderService.getProviders(category: 'كهرباء'),
      _fetchSavedIds(),
    ]);
    if (!mounted) return;
      ...
      builder: (context, themeProvider, child) {
        ...
        return Scaffold(
          ...
          body: _isLoading
              ...
              : workers.isEmpty
                  ? Center(
                      child: Text(context.l10n.noElectricians,
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) => _buildCard(
                        workers[index], cardBg, textColor, placeholderBg, isDark,
                      ),
                    ),
  ...
  // --- كرت الفني الديناميكي الداعم للـ Dark Mode والانتقال لصفحة التفاصيل ---
  Widget _buildCard(
    Worker w,
    Color cardBg,
    Color textColor,
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            ...
            // القسم الأوسط: نصوص البيانات والتاج الخاص بالحالة
            Column(
            ...
            // القسم الأيمن: إطار الصورة أو الحرف الأول البديل
            ClipRRect(
