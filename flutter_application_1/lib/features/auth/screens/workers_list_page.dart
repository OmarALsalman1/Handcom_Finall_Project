...
class _WorkersListPageState extends State<WorkersListPage> {
  ...
  Future<void> _toggleSave(Worker w) async {
    ...
    ScaffoldMessenger.of(context)
      ...
      ..showSnackBar(SnackBar(
        content: Text(
          willSave && success ? savedMsg : unsavedMsg,
  ...
  Future<void> _loadWorkers() async {
    final results = await Future.wait([
      ProviderService.getProviders(category: 'سباكة'),
      _fetchSavedIds(),
    ]);
    if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    // استخدام Consumer للمراقبة الديناميكية لوضع الثيم العالمي داخل شاشة قائمة الفنيين
    return Consumer<ThemeProvider>(
      builder: (context, themeProvider, child) {
        final bool isDark = themeProvider.isDarkMode;

        // تهيئة الألوان المتغيرة حسب وضع الثيم الحالي
        ...
        final Color placeholderBg =
            isDark ? const Color(0xFF2C2C2C) : const Color(0xFFD1E8FF);
        ...
        return Scaffold(
          ...
          body: _isLoading
              ...
              : workers.isEmpty
                  ? Center(
                      child: Text(context.l10n.noPlumbers,
                          style: TextStyle(
  ...
  // --- كرت الفني الديناميكي التفاعلي الداعم للـ Dark Mode والنوت المنبثق ---
  Widget _buildCard(Worker w, Color cardBg, Color textColor,
      Color placeholderBg, bool isDark) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            // القسم الأيسر: المفضلة والتقييم
            Column(
              children: [
                IconButton(
                  icon: Icon(w.isSaved ? Icons.bookmark : Icons.bookmark_border,
            ...
            // القسم الأوسط: تفاصيل الفني والتاج الملون الجديد للحالة
            Column(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Icon(Icons.location_on,
                        size: 14, color: isDark ? Colors.white60 : Colors.grey),
                  ],
                ),
              ],
            ),
            ...
            // القسم الأيمن: إطار الحرف التعريفي الأول للموظف
            ClipRRect(
  ...
  // --- البار السفلي المتناسق لـ فلاتر الحديث والمعالج من الأخطاء ---
