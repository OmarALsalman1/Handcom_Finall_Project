...
class PaintWorkersPage extends StatefulWidget {
  const PaintWorkersPage({super.key});

  @override
  State<PaintWorkersPage> createState() => _PaintWorkersPageState();
}

class _PaintWorkersPageState extends State<PaintWorkersPage> {
  ...
  Future<void> _loadWorkers() async {
    final results = await Future.wait([
      ProviderService.getProviders(category: 'دهان'),
      _fetchSavedIds(),
    ]);
    if (!mounted) return;
  ...
  // --- كرت الفني الديناميكي المطور بـ كبسة الانتقال ونوت الحفظ التفاعلي ---
  Widget _buildCard(BuildContext context, Worker w, Color cardBg,
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            // القسم الأيسر: المفضلة والتقييم بالنجوم
            Column(
              children: [
                IconButton(
                  icon: Icon(
            ...
            // القسم الأوسط: تفاصيل الفني وتاغ الحالة الموحد
            Column(
            ...
            // القسم الأيمن: إطار الصورة أو أول حرف تعريفي بديل
            ClipRRect(
              ...
              child: Container(
                ...
                child: w.imageUrl.isNotEmpty
                    ? Image.network(
                        ...
                        fit: BoxFit.cover,
                        errorBuilder: (c, e, s) =>
                            _placeholder(w.char, placeholderBg, textColor),
                      )
                    : _placeholder(w.char, placeholderBg, textColor),
              ),
            ),
  ...
  Widget _placeholder(String char, Color placeholderBg, Color textColor) {
    return Container(
      color: placeholderBg,
      child: Center(
        child: Text(
  ...
  // --- البار السفلي المطور والمعالج بالكامل من أخطاء التظليل والتحديد ---
